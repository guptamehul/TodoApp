...
/**
  ...
  @param {Boolean} disable Set this to true to disable SDK from tracking user metrics
  @memberof Built
*/
module.exports.disableUserMetrics = function (isDisabled) {
  defaultOptions.analyticsConfig.isUserMetricsDisabled = isDisabled
